    ...
    <section id="sobre" className="py-24 px-8">
      ...
      <div className="p-8 max-w-200 mx-auto rounded-2xl border-2 border-(--vidro) backdrop-blur-sm bg-[rgba(255,255,255,0.05)]">
        <p className="text-center text-[1.2rem]">
          ...
          React, Node.js e bancos de dados SQL e NoSQL. Tenho experiência na
          criação de APIs REST e aplicações web, trabalhando com tecnologias
          como JavaScript, TypeScript, React, Tailwind CSS, Node.js, MySQL,
          PostgreSQL e MongoDB. Também utilizo Docker para containerização das
          aplicações e Git para controle de versão. Além disso, possuo
          conhecimentos em Java (Programação Orientada a Objetos) e Python.
